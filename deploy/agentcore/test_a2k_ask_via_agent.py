"""One-off probe: calls a2k.ask on the mcp_to_agent_to_mcp branch's a2k-box
Runtime (IAM/SigV4, same pattern as test_remote_mcp_iam.py in this
directory) to confirm the full chain works end to end:

    external caller (this script, IAM)
      -> a2k-box's MCP (a2k.ask)
...
Usage:
    ...
    python test_a2k_ask_via_agent.py "Acme Robotics"
"""
...
def main() -> None:
    ...
    init_response = _call(
        ...
        payload={
            ...
            "params": {
                ...
                "capabilities": {},
                "clientInfo": {"name": "test_a2k_ask_via_agent", "version": "1.0"},
            },
        },
    )
    ...
    # directly like this, it should just be "a2k.ask" bare, not
